        ...
        loginBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!TextUtils.isEmpty(loginEmail) && !TextUtils.isEmpty(loginPass) ){
                    ...
                    //因为虚拟机不能翻墙，连接不到mAuth服务，所以此处登陆简化为：备案账户检查后登陆
                    /**
                    ...
                    */
                            ...
                            if (loginEmail.equals("lxylearning@outlook.com") && loginPass.equals("lxy201011lxyhh")  ){

                                sendToMain();

                            }else {
                                Toast.makeText(LoginActivity.this,"Error : check your email and password , Please try again",Toast.LENGTH_LONG).show();
